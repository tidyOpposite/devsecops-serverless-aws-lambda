...
def build_parser() -> argparse.ArgumentParser:
    ...
    validate_config_parser = subparsers.add_parser("validate-config", help="Validate local source config values.")
    ...
    config_parser = subparsers.add_parser("config", help="Print local source config.")
